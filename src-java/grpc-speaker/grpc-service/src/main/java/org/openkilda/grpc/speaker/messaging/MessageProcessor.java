...
public class MessageProcessor {
     ...
     */
    public void processRequest(Message message, Single key) {
    ...
    private void handleGetPacketInOutStatsRequest(GetPacketInOutStatsRequest request, String correlationId, String key) {
