...
public class FlowRerouteServiceTest extends AbstractFlowTest {
    ...
    @Test
    public void shouldMakeFlowDontOnTimeoutIfEffectivelyDown() throws RecoverableException, UnroutableFlowException {
        Flow origin = makeFlow();
        preparePathComputation(origin.getFlowId(), make3SwitchesPathPair());
    ...
    public void shouldProcessRerouteForValidRequest() throws RecoverableException, UnroutableFlowException {
        ...
        service.handleRequest(new FlowRerouteFact(
                currentRequestKey, commandContext, origin.getFlowId(), Collections.singleton(affectedEndpoint), false, true,
                null));
        verifyFlowStatus(origin.getFlowId(), FlowStatus.IN_PROGRESS);
    ...
    public void shouldSkipRerouteOnOutdatedRequest() {
        ...
        service.handleRequest(new FlowRerouteFact(
                currentRequestKey, commandContext, origin.getFlowId(), Collections.singleton(notAffectedEndpoint), false, true,
                null));
