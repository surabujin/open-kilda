...
public class RemoveOldRulesAction extends FlowProcessingAction<FlowRerouteFsm, State, Event, FlowRerouteContext> {
    ...
    protected void perform(State from, State to, Event event, FlowRerouteContext context, FlowRerouteFsm stateMachine) {
        ...
        if (stateMachine.getOldPrimaryForwardPath() != null && stateMachine.getOldPrimaryReversePath() != null) {
            FlowPathSpeakerView oldForward = injectActualFlowPath(stateMachine.getOldPrimaryForwardPath());
            FlowPathSpeakerView oldReverse = injectActualFlowPath(stateMachine.getOldPrimaryReversePath());
