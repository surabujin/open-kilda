...
public class CompleteFlowPathRemovalAction extends
    ...
    private void removeFlowPaths(FlowRerouteFsm stateMachine) {
        ...
        if (stateMachine.getOldPrimaryForwardPath() != null && stateMachine.getOldPrimaryReversePath() != null) {
            oldPrimaryForward = injectActualFlowPath(flow, stateMachine.getOldPrimaryForwardPath());
            oldPrimaryReverse = injectActualFlowPath(flow, stateMachine.getOldPrimaryReversePath());
        }
        ...
        if (stateMachine.getOldProtectedForwardPath() != null
            ...
            oldProtectedForward = injectActualFlowPath(flow, stateMachine.getOldProtectedForwardPath());
            oldProtectedReverse = injectActualFlowPath(flow, stateMachine.getOldProtectedReversePath());
        }
