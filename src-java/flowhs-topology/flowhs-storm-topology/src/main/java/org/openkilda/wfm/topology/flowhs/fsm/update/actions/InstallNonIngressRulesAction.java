...
public class InstallNonIngressRulesAction
    ...
    protected void perform(State from, State to,
        ...
        // primary path
        FlowPathSpeakerView newPrimaryForward = injectActualFlowPath(flow, stateMachine.getNewPrimaryForwardPath());
        FlowPathSpeakerView newPrimaryReverse = injectActualFlowPath(flow, stateMachine.getNewPrimaryReversePath());
        ...
        if (stateMachine.getNewProtectedForwardPath() != null && stateMachine.getNewProtectedReversePath() != null) {
            FlowPathSpeakerView newProtectedForward = injectActualFlowPath(flow, stateMachine.getNewProtectedForwardPath());
            FlowPathSpeakerView newProtectedReverse = injectActualFlowPath(flow, stateMachine.getNewProtectedReversePath());
