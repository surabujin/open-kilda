...
public class ResourcesAllocationAction extends NbTrackableAction<FlowCreateFsm, State, Event, FlowCreateContext> {
    ...
    private void allocateMainPath(FlowCreateFsm fsm, Flow flow) throws UnroutableFlowException,
        ...
        fsm.setForwardPath(makeFlowPathNewView(sharedOfFlowManager, flow, forward, flowResources.getForward()));
        fsm.setReversePath(makeFlowPathNewView(sharedOfFlowManager, flow, reverse, flowResources.getReverse()));
    ...
    private void allocateProtectedPath(FlowCreateFsm fsm, Flow flow) throws UnroutableFlowException,
        ...
        fsm.setProtectedForwardPath(
                makeFlowPathNewView(sharedOfFlowManager, flow, forward, flowResources.getForward()));
        ...
        fsm.setProtectedReversePath(
                makeFlowPathNewView(sharedOfFlowManager, flow, reverse, flowResources.getReverse()));
