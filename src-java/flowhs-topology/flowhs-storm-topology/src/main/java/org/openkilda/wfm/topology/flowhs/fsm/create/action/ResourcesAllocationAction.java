...
public class ResourcesAllocationAction extends NbTrackableAction<FlowCreateFsm, State, Event, FlowCreateContext> {
    ...
    private void allocateMainPath(FlowCreateFsm fsm, Flow flow) throws UnroutableFlowException,
        ...
        fsm.setForwardPath(makeFlowPathNewView(forward, flowResources.getForward()));
        fsm.setReversePath(makeFlowPathNewView(reverse, flowResources.getReverse()));
    ...
    private void allocateProtectedPath(FlowCreateFsm fsm, Flow flow) throws UnroutableFlowException,
        ...
        fsm.setProtectedForwardPath(
                makeFlowPathNewView(forward, flowResources.getForward()));
        ...
        fsm.setProtectedReversePath(
                makeFlowPathNewView(reverse, flowResources.getReverse()));
