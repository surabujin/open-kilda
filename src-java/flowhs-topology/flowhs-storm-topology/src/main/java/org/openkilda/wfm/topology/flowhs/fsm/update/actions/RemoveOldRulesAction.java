...
public class RemoveOldRulesAction extends BaseFlowRuleRemovalAction<FlowUpdateFsm, State, Event, FlowUpdateContext> {
    ...
    protected void perform(State from, State to, Event event, FlowUpdateContext context, FlowUpdateFsm stateMachine) {
        ...
        FlowPathSpeakerView oldPrimaryForward = injectActualFlowPath(stateMachine.getOldPrimaryForwardPath());
        FlowPathSpeakerView oldPrimaryReverse = injectActualFlowPath(stateMachine.getOldPrimaryReversePath());
        ...
        if (stateMachine.getOldProtectedForwardPath() != null && stateMachine.getOldProtectedReversePath() != null) {
            FlowPathSpeakerView oldForward = injectActualFlowPath(stateMachine.getOldProtectedForwardPath());
            FlowPathSpeakerView oldReverse = injectActualFlowPath(stateMachine.getOldProtectedReversePath());
