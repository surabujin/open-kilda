...
public abstract class RequestedFlowMapper {
    ...
    public RequestedFlow toRequestedFlow(FlowRequest request) {
        ...
        mapRequestedFlowSource(flow, request.getSource());
        mapRequestedFlowDestination(flow, request.getDestination());
        return flow;
    }
    ...
    protected abstract void mapRequestedFlowSource(@MappingTarget RequestedFlow target, FlowEndpoint endpoint);
    ...
    protected abstract void mapRequestedFlowDestination(@MappingTarget RequestedFlow target, FlowEndpoint endpoint);
