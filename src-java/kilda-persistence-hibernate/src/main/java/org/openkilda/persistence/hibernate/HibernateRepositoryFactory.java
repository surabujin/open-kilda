...
public class HibernateRepositoryFactory implements RepositoryFactory {
    ...
    public HibernateRepositoryFactory(
            SessionFactory sessionFactory, TransactionManagerFactory transactionManagerFactory) {
    ...
    public FlowHistoryRepository createFlowHistoryRepository() {
        return new HibernateHistoryFlowEventActionRepository(
                transactionManagerFactory.produce(TransactionArea.HISTORY), sessionFactory, makeFlowEventRepository());
    }
    ...
    public PortHistoryRepository createPortHistoryRepository() {
        return new HibernateHistoryPortEventRepository(
                transactionManagerFactory.produce(TransactionArea.HISTORY), sessionFactory);
    }
