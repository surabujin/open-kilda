...
public abstract class SwitchConnectFrame extends KildaBaseEdgeFrame implements SwitchConnectData {
    ...
    public Speaker getSpeaker() {
        if (speaker == null) {
            Iterator<? extends SpeakerFrame> speakerIterator = traverse(e -> e.outV().hasLabel(SpeakerFrame.FRAME_LABEL))
    ...
    public Switch getOwner() {
        if (owner == null) {
            Iterator<? extends SwitchFrame> ownerIterator = traverse(e -> e.inV().hasLabel(SwitchFrame.FRAME_LABEL))
