...
public class FermaRepositoryFactory implements RepositoryFactory {
    ...
    public FeatureTogglesRepository createFeatureTogglesRepository() {
        return new FermaFeatureTogglesRepository(
                graphFactory, transactionManagerFactory.produce(TransactionArea.COMMON));
    }
    ...
    public FlowHistoryRepository createFlowHistoryRepository() {
        return new FermaFlowHistoryRepository(graphFactory, transactionManagerFactory.produce(TransactionArea.HISTORY));
    }

    @Override
    public FlowDumpRepository createFlowDumpRepository() {
        return new FermaFlowDumpRepository(graphFactory, transactionManagerFactory.produce(TransactionArea.HISTORY));
    }
    ...
    public PortHistoryRepository createPortHistoryRepository() {
        return new FermaPortHistoryRepository(graphFactory, transactionManagerFactory.produce(TransactionArea.HISTORY));
    }
