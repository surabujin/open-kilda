...
public class SqlHistoryRepositoryFactory implements RepositoryFactory {
    ...
    public SqlHistoryRepositoryFactory(
        ...
        hibernateRepositoryFactory = new HibernateRepositoryFactory(sessionFactory, transactionManagerFactory);
    }
    ...
    public FlowHistoryRepository createFlowHistoryRepository() {
        return hibernateRepositoryFactory.createFlowHistoryRepository();
    }

    @Override
    public FlowDumpRepository createFlowDumpRepository() {
        return hibernateRepositoryFactory.createFlowDumpRepository();
    }
    ...
    public PortHistoryRepository createPortHistoryRepository() {
        return hibernateRepositoryFactory.createPortHistoryRepository();
    }
