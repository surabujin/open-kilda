...
public class SwitchAvailabilityUpdateCommand extends SwitchCommand {
    private final SwitchAvailabilityData availabilityData;

    public SwitchAvailabilityUpdateCommand(SwitchId switchId, SwitchAvailabilityData availabilityData) {
        super(switchId);
