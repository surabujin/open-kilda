...
public class SwitchMonitorBolt extends AbstractBolt implements SwitchMonitorCarrier {
    ...
    @Override
    public void sendSwitchConnectNotification(SwitchId switchId, SpeakerSwitchView speakerData, SwitchAvailabilityData availabilityData) {
        sendOtherNotification(switchId, new SwitchConnectNotification(speakerData, availabilityData));
    }

    @Override
    public void sendSwitchDisconnectNotification(SwitchId switchId, SwitchAvailabilityData availabilityData, boolean isRegionOffline) {
