...
public class SharedIngressFlowSegmentOuterVlanMatchInstallCommand
    ...
    protected List<OFInstruction> makeFlowModMessageInstructions() {
        ...
        MetadataAdapter metadataAdapter = MetadataAdapter.selectAdapter(getSwitchFeatures());
        MetadataAdapter.MetadataMatch metadata = metadataAdapter.addressOuterVlan(
