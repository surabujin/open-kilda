...
public class EthernetPacketToolbox {
     ...
     */
    public IPacket injectVlan(IPacket payload, int vlanId, EthType type) {
     ...
     */
    public IPacket extractEthernetPayload(Ethernet packet, List<Integer> vlanStack) {
    ...
    protected EthernetPacketToolbox() {
